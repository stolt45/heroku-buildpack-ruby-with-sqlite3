...
WARNING
        ...
        Dir.mktmpdir("libyaml-") do |tmpdir|
          ...
          run("bundle config --global build.sqlite3 -- --srcdir=#{File.expand_path(  '../../vendor/sqlite3', $PROGRAM_NAME )} --with-sqlite3-lib=#{File.expand_path(  '../../vendor/sqlite3/lib', $PROGRAM_NAME )} ")
          puts `bundle config`
